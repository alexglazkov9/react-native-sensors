...
public class Temperature extends ReactContextBaseJavaModule implements SensorEventListener {
  ...
  public Temperature(ReactApplicationContext reactContext) {
    super(reactContext);
  ...
  public void isAvailable(Promise promise) {
    if (this.sensor == null) {
      ...
      promise.reject(new RuntimeException("No temperature sensor found"));
      return;
    }
